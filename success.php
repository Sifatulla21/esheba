...
$_SESSION['cmrId'] = $_COOKIE['user_id'];
$_SESSION['cmrname'] = $_COOKIE['cmrname'];
...
if($code == 200 && !( curl_errno($handle)))
{
	...
	echo '<tr><th></th><td><a href="home.php">View ORDER</a></td></tr>';
	echo '</table></div>';
	$Order->UpdateOrder($card_type, $tran_id, $_SESSION['cmrId']);
} else {
