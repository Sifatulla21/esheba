...
<div class="wrapper">
	<nav id="sidebar">
		...
		<ul class="lisst-unstyled components">
			...
			<li >
				<a href="#pdfmenu" data-toggle="collapse" arial-expanded="false" class="dropdown-toggle text-muted"><i class="fa fa-user-md text-danger "></i>Doctors</a>
				<ul class="collapse lisst-unstyled" id="pdfmenu">
					<li>
						<a href="doctors.php"><i class="fa fa-align-left"></i>View All Doctors</a>
					</li>
					<li>
			...
			<li>
				<a href="location.php" class="text-muted"><i class="fa fa-location-arrow text-danger"></i>Location</a>
			</li>
			<li>
				<a href="hospital.php" class="text-muted"><i class="fa fa-hospital-o text-danger"></i>Hospital</a>
			</li>
			<li>
				<a href="apointment.php" class="text-muted"><i class="fa fa-crosshairs text-danger"></i>ApointMent</a>
			</li>
			<li>
				<a href="pharmacy.php" class="text-muted"><i class="fa fa-stethoscope text-danger"></i>Pharmacy</a>
			</li>
			<li>
				<a href="oxygen.php" class="text-muted"><i class="fa fa-heart text-danger"></i>Oxygen</a>
			</li>
			<li>
				<a href="seller.php" class="text-muted"><i class="fa fa-user text-danger"></i>Seller</a>
			</li>
		</ul>
	</nav>
	<div id="content">
