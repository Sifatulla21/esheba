				...
				?>
					...
					<div class="col-lg-4">
						<div class="bg-info m-1">
							<img src="images/<?php echo $row['img']; ?>" style="width: 100%;height: 300px;">
							...
							<div class="d-flex justify-content-between p-2">
								<button class="btn btn-outline-warning mr-1 addtocartoxygen" id="<?php echo $row['cylinder_id']; ?>">Add to Cart</button>
